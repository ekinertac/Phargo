...
**`.phpt` pass rate: 2216 / 21862  (10.14% of the entire PHP test suite)**

_This counts only the upstream **php-src** test suite — tests we did **not** write. Among tests the runner can currently grade (21796): 10.17%. The 66 "not-yet-gradeable" tests have no `--EXPECT--`/`--EXPECTF--` (e.g. `--EXPECTREGEX--` or output-less)._
...
|---|---:|---:|---:|
| `Zend` | 879 | 5329 | 16.5% |
| `ext/standard` | 435 | 3877 | 11.2% |
| `ext/opcache` | 389 | 916 | 42.5% |
| `core` | 160 | 868 | 18.4% |
| `ext/dom` | 8 | 868 | 0.9% |
| `ext/spl` | 78 | 796 | 9.8% |
| `ext/date` | 55 | 689 | 8.0% |
